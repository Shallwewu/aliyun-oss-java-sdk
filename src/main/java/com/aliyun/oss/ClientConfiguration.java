...
public class ClientConfiguration {
    ...
    public static final int DEFAULT_MAX_CONCURRENT_REQUEST = 64;
    ...
    protected int maxConcurrentRequest = DEFAULT_MAX_CONCURRENT_REQUEST;
    ...
    /**
     * Gets the max concurrent request.
     *
     * @return The max concurrent request. By default it's 64. For async request, Connection pool will create 64 thread for concurrent tasks at most.
     */
    ...
    /**
     * Sets the max concurrent request.
     *
     * @param maxConcurrentRequest
     *            The max concurrent request.
     */
